...
let AddEmailComponent = class AddEmailComponent {
    ...
    // set error
    setError(shouldSetError, errorText = '') {
...
AddEmailComponent.ctorParameters = () => [
...
let EmailDetailComponent = class EmailDetailComponent {
    ...
    selectUserToEmail(user) {
        this.selectedUser = user;
    }
    // set modal errors
    setModalError(shouldSetError, errorText = '') {
        this.error = shouldSetError;
        this.errorMessage = errorText;
    }
    // call api to assign the user to the email
    assignUserToEmail(user) {
...
let FilterPipe = class FilterPipe {
    ...
    transform(data, prop, value, method) {
        if (data) {
            if (!value) {
                return data;
            }
...
let AuthService = class AuthService {
    ...
    setLoggedIn(isLoggedIn, user = {}, token = '') {
